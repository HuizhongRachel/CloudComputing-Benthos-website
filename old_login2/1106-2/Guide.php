...
<div class="dropdown dropdown-dark">
  <select name="select_price2"  id="select_price2" class="dropdown-select" >
    <option>Choose Skin Type</option>
    <option>$0   ~ $30</option>
    <option>$30  ~ $60</option>
    <option>$60  ~ $100</option>
    <option>$100 ~ $200</option>
...
<div class="dropdown dropdown-dark">
  <select name="select_price2"  id="select_price3" class="dropdown-select" >
